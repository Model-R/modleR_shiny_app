                ...
                column(width = 6,
                    ...
                    column(width = 6,
                      ...
                      box(width = 6, solidHeader = TRUE, collapsible = TRUE, title="Future conditions" ,
                        box(width = 12, solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE, title="Time period" ,
                      checkboxGroupInput("periodo", "Time period:", periodo)
                        ),
                        box(width = 12, solidHeader = TRUE, collapsible = TRUE,collapsed = TRUE, title="General Circulation Models (GCM)",
                      checkboxGroupInput("gcm", "General Circulation Models (GCM):", gcm, selected = "bc")
                        ),
                        box(width = 12, solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,title="Emission Scenarios (RCP)",
